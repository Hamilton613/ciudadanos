...
<head>
  <meta charset="UTF-8">
  <title>Listado de Niveles Academicos</title>
...
<body class="bg-light">
  ...
  <div class="container mt-5">
    <h2 class="text-center mb-4">Listado De Nivel Academicos</h2>
        ...
        <?php while ($datos = mysqli_fetch_assoc($ejecutar)) { ?>
          <tr>
            ...
            <td class="d-flex justify-content-center gap-2">
              <form action="crud_nivel.php" method="post">
                <input type="hidden" name="hidden_eli" id="hidden_eli" value="<?php echo htmlspecialchars($datos['cod_nivel_acad']); ?>">
                <button type="submit" name="btn_eli" id="btn_eli" class=" btn btn-outline-danger">
                  <i class="bi bi-trash3-fill"></i>
                </button>
              </form>
              <form action="form_acd_nivel.php" method="post">
                <input type="hidden" name="hidden_acta" id="hidden_acta" value="<?php echo htmlspecialchars($datos['cod_nivel_acad']); ?>">
